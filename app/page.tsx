...
export default function Home() {
  return (
          ...
          <div className="grid items-center justify-center gap-4 text-center">
            ...
            <div className="mx-auto w-full max-w-sm space-y-2">
              <form className="flex flex-col space-y-4">
                <Input className="max-w-lg" placeholder="성함" type="text" />
                <Input className="max-w-lg" placeholder="메일" type="email" />
                <Textarea className="max-w-lg" placeholder="메시지" rows={4} />
    ...
    <footer className="flex flex-col gap-2 sm:flex-row py-6 w-full shrink-0 items-center px-4 md:px-6 border-t">
      <p className="text-xs text-gray-500 dark:text-gray-400">© 2024 Jeayeon-Park. All rights reserved.</p>
